...
//    }
    ...
    private static ChatModel createOllamaChatModel() {
    ...
    private static EasyRAGAssistant createEasyRAGAssistant(ChatModel chatModel, ContentRetriever contentRetriever) {
